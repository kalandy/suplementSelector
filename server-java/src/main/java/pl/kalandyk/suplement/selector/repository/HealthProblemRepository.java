...
/*!
* \brief Klasa HealthProblemRepository,klasa tworząca przez springa repozytorium do bazy danych dla HealthProblem (ktory ma id typu Long)
*
* utworzenie przez springa repozytorium do bazy danych dla HealthProblem (ktory ma id typu Long)
*/
